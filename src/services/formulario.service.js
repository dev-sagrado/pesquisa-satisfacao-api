...
exports.criarFormulario = async (req, res) => {
    console.log("Body:", req.body);  // Adicionando log para debug

    const { titulo, perguntas } = req.body;
    console.log("titulo:", titulo);  // Adicionando log para debug
    console.log("perguntas:", perguntas);  // Adicionando log para debug
